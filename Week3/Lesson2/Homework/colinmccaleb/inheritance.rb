...
bill_lumberg = Manager.new("Bill", "Lumberg", "Boss", "blumby@some.co.com")
puts bill_lumberg.full_name
puts bill_lumberg.contact
puts "============"
jan = Marketer.new("Jan", "L@STn@ME", "@jantweets")
puts jan.full_name
puts jan.contact
puts "============"
joe = Employee.new("Joe", "Everyman")
puts joe.full_name
puts "============"
